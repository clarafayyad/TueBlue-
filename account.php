...
<head>
	...
	$(document).ready(function($){
        ...
        $("#bt_confirm").click(function(){
            $.ajax({
                    ...
                    success: function(data){
                                ...
                                {
                                    $("#changepassword").hide();
                                    $(".modal-body").html("Password changed successufully.");
							        $("#modalbutton").click();
                                }                               
                        },
                 });
        ...
        $("#bt_gov").click(function(){
            $.ajax({
                    url: 'changegov.php',
                    type: "POST",
                    datatype: "text",
                    data: {"governorate":$("#gov option:selected").text(),},
            ...
            $.ajax({
                    ...
                    success: function(data){
                                 if(data=="empty")
                                    ...
                                    {
                                        $(".modal-body").html("Address changed succesfully");
                                        $("#modalbutton").click();
                                        setTimeout(function(){window.location.href="account.php";}, 2000);  
                                    }                              
                        },
	...
	<div id="pageWrapper">
        ...
        <!-- Modal -->
            ...
            <?php 
                ...
                $sql = "SELECT phonenumber, gov, location, firstname, lastname, email FROM customers WHERE username = '{$username}' ";
                ...
                $gov=$row[1];
                $location=$row[2];
                $name=ucfirst($row[3])." ".ucfirst($row[4]);
                $email=$row[5];
            ?>
			<!-- featureSec -->
			<section  class="featureSec container overflow-hidden pt-xl-12 pb-xl-9 pt-lg-10 pb-lg-4 pt-md-8 pb-md-2 pt-5">
				<div class="row">
					...
					<header class="col-12 mainHeader mb-4 text-center">
                        ...
                        <p class="headingI playfair fwEblod mb-4">Governorate: <?=$gov?></p>
                    ...
                    <section class="container-fluid bg">
                        <section class="row justify-content-center">
                            ...
                            <section class="col-sm-12 col-md-2 mt-5">
                                <div style="text-align:center">
                                <button id="change_gov" class="btn btnTheme btnShop fwEbold text-white py-3 px-3">Change <br> Governorate</button>
                                </div>
                            </section>
                            <section class="col-sm-12 col-md-2 mt-5">
                                <div style="text-align:center">
                    ...
                    <div id="changenumber" class="container form-group" style="text-align:center">
						...
						<input style="width:250px; border-width: 1.5px; margin-right:auto;margin-left:auto;color:white;margin-bottom:10px" id="phone" type="tel" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"class="form-control" id="exampleInputNumber" maxlength=8 placeholder="78888777" pattern="[0-9]{8}">	
                    ...
                    <div id="changepassword" class="container form-group" style="text-align:center">
						...
						<input style="width:250px; border-width: 1.5px; margin-right:auto;margin-left:auto;color:white;" id="pass10" type="password" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"class="form-control" placeholder="Password">	
                    ...
                    <div id="changegov" class="container form-group" style="text-align:center">
                    <p style="color:black">Select your governorate</p>
                      <select style="border-width: 1.5px;color:white; width:300px; margin-right:auto; margin-left:auto;margin-bottom:10px" id="gov" class="form-control" id="exampleInputGov">
                      ...
                      <button id="bt_gov" type="button" class="btn btnTheme btnShop fwEbold text-white py-3 px-4" style="display: inline-block;">Submit</button>                    
                    </div> 
